...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            extErrorStr: "허용되지 않은 확장자입니다. 허용된 확장자: ",
        ...
        this.createProgress = function (filename,filepath,filesize,gUrl) {
            ...
            {
                pd.link.show();
                pd.link.click(function () {
                    if (is_ie()) {
                        window.clipboardData.setData("Text", gUrl + '/' + filepath);
                        alert("복사되었습니다.");
                    } else {
                        prompt("Ctrl+C를 눌러 복사하세요.", gUrl + '/' + filepath);
                    }
                });
            }
            if(s.showVideo)
            {
                pd.popup.show();
                pd.popup.click(function () {
                    var popupWindow = window.open( filepath, "MoviePreview", "left=200, top=100, status=0, width=650, height=550" );
                    popupWindow.focus();
                });
            }
        ...
        function defaultProgressBar(obj,s)
        {
            ...
            this.link = $("<div>" + s.linkStr + "</div>").appendTo(this.statusbar).hide();
            this.popup = $("<div>" + s.popupStr + "</div>").appendTo(this.statusbar).hide();
            ...
            this.link.addClass("ajax-file-upload-blue");
            this.popup.addClass("ajax-file-upload-yellow");
